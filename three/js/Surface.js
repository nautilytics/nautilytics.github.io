...
AEROTWIST.Surface = new function () {
    ...
    function createObjects() {
        var planeMaterial = new THREE.MeshLambertMaterial({ color: (1, 1, 255), shading: THREE.SmoothShading });

        surface = new THREE.Mesh(new Plane(SURFACE_WIDTH, SURFACE_HEIGHT, X_RESOLUTION, Y_RESOLUTION), planeMaterial);
